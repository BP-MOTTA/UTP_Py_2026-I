...
DATA_DIR= ROOT/"Semana 4"/"Datos"/"processed"
FILENAME= "Sensor93_04.csv"
CSV_PATH = DATA_DIR/FILENAME
print(f"Ruta del archivo CSV: {CSV_PATH}")
if not CSV_PATH.exists():
    raise FileNotFoundError(f"No existe: {CSV_PATH}")
#Enrutamiento de salida
PLOTS_DIR=ROOT/"Semana 8"/"plots"
...
for t, v in zip(alerta_t, alerts_v):
    ax.annotate(f"{v:.2f}V",               # Permite ver los puntos donde se pasa del umbral
                ...
                xytext=(0, 8),             # desplazamiento de  l texto (px)
